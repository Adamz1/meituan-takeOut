    ...
    <div class="ratings-wrapper">
			...
			<div class="content">
				...
				<div class="labels-view">
					<span v-for="item in ratings.labels" class="item" :class="{'highligh':item.label_star>0}" :key="item.label_count">
						{{item.content}}{{item.label_count}}
					</span>
				</div>

				<ul class="rating-list">
					<li v-for="comment in selectComments" class="comment-item" :key="comment.user_pic_url">
						...
						<div class="comment-main">
							...
							<div class="img-wrapper" v-if="comment.comment_pics.length">
								<img v-for="item in comment.comment_pics" :src="item.thumbnail_url" :key="item.thumbnail_url" />
							</div>
						</div>
					</li>
				</ul>
